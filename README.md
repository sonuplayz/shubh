...
<body>
    <div class="container">
        ...
        <p id="prankResult" class="hidden reveal"></p>
    </div>
    ...
    <script>
        function revealCrush() {
            ...
            let prankResult = document.getElementById('prankResult');
            
            if (crushName) {
                result.classList.remove('hidden');
                prankResult.classList.remove('hidden');
                result.textContent = "Haha! Your crush is: " + crushName + "!";
                prankResult.textContent = "But guess what? You just revealed the name of your crush!";
            } else {
                result.classList.add('hidden');
                prankResult.classList.add('hidden');
